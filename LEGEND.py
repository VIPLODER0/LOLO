...
from telegram.ext import (
    Application,
    CommandHandler,
    CallbackQueryHandler,  # Correctly Added
    ContextTypes,  # Correctly Added
    MessageHandler,
    filters
)
...
def main():
    ...
    # Register command handler for /start1
    application.add_handler(CommandHandler("start1", start))
